      ...
      <nav class="navbar is-link " role="navigation" aria-label="main navigation">
        <div class="container">
                ...
                <div class="navbar-end">
                    <a href="./menue.php" class="navbar-item">
                      Regresar
                    </a>
<!--
        ...
        <div class="column is-two-desktop is-flex is-flex-direction-column is-justify-content-space-between is-three-quarters-mobile">
            ...
            <form action="./QRCode/main.php" method="post" class="box">
              ...
              <div class="column is-two-desktop is-flex is-flex-direction-column is-justify-content-space-between is-three-quarters-mobile">
                ...
                <div class="field">
                  <label class="label">1.- ¿Cual es tu Matrícula?</label>
                      <div class="control">
                        <input class="input" type="text" name="matricula" id="matricula" placeholder="15GH..." onkeyup="this.value = this.value.toUpperCase();" required>
                      </div>
                </div>
