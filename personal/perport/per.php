...
<!-- 
    ...
    <div class="columns space box">
        ...
        <div class="column ">
            <form action="" method="GET">
                <h2 class="title is-5">Coloca El Correo</h2>
        ...
        <div class="column ">
            <?php 
                if(isset($_GET['send'])){
                    $search = $_GET['search'];
                    $select = "SELECT * FROM PERSONAL WHERE CORREO LIKE '%".$search."%'";
                    $consulta = $mysql->query($select);

                    $rowcount=mysqli_num_rows($consulta);
                    $found;
                    if($rowcount >1){
                        $found = "Correos encontrados: ".$rowcount;
                    }else{
                        $found = "Correo encontrado: ".$rowcount;;
                    }
                ...
                <form action="" method="POST">
                            ...
                            <select name="mat" required>
                                    ...
                                    <option> <?php echo $filas["CORREO"] ?></option>
                                    <?php  }?>
                                    </select>
                                    </div>                                            
                            </div>
    ...
    <?php } ?>
            ...
            if(isset($_POST['fin'])){
                ...
                $select_estudiante = "SELECT * FROM PERSONAL WHERE CORREO = '".$search."'";
                ...
                if($forms>0){
                    foreach($consulta_E as $up){
                        $Matricula = $up['CORREO'];
                        $Nombre = eliminar_tildes($up['NOMBRE']." ".$up['APELLIDOS']);
                        //$Grado = $up['GRADO'];
                        $Nivel = $up['NIVEL'];
                    }
